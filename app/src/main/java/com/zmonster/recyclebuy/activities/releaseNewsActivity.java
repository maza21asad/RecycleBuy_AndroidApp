...
import com.zmonster.recyclebuy.adapter.InformationAdapter;
...
public class releaseNewsActivity extends DefaultActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setActionBarTitle(getString(R.string.release_news));
    ...
    private void initData() {
        ...
        listAdapter = new InformationAdapter(this);
    ...
    private void refresh() {
        ...
        if (userID != 0) {
            ...
            List<Information> datas = InformationProxy.getInstance().findInfo(userID + "");
            if (datas != null) {
    ...
    private void initView() {
        ...
        addEvent.setOnClickListener(v -> {
            Intent in = new Intent(releaseNewsActivity.this, InfoCreateActivity.class);
            startActivity(in);
        });
    }
