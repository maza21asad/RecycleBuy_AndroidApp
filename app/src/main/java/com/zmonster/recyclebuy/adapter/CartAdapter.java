...
import com.zmonster.recyclebuy.holder.CartItemViewHolder;
...
public class CartAdapter extends RecyclerView.Adapter<BaseViewHolder> {
    ...
    private List<Cart> mData = new ArrayList<>();
    ...
    public void setDatas(List<Cart> datas) {
    ...
    public BaseViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        BaseViewHolder holder = new CartItemViewHolder(LayoutInflater.from(mActivity).inflate(R.layout.cart_item_view, parent, false));
        if (mActivity != null) {
    ...
    public void onBindViewHolder(BaseViewHolder holder, int position) {
        final Cart item = mData.get(position);
