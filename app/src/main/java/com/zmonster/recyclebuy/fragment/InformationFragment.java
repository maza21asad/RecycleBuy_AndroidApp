...
public class InformationFragment extends Fragment {
    ...
    private void initData() {
        ...
        listAdapter = new InformationAdapter(mActivity);
    ...
    private void initView() {
        ...
        actionBarTitle.setText(getString(R.string.information));
    ...
    private void refresh() {
        ...
        mActivity.runOnUiThread(() -> {
            ...
            List<Information> datas = InformationProxy.getInstance().getALL();
